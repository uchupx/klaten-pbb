<template>
    <!-- component -->
    <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-gray-800 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            ...
            <nav class="-mx-3 space-y-6 ">
                    ...
                    <!-- <label class="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">analytics</label> -->
										<template v-for="item in items" :key="'route'+ item.name">
											<a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 border-gray-800 border hover:border-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-300" :href="item.path">
